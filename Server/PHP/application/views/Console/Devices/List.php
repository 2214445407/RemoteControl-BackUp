...
<head>
	...
	<title>设备列表 - <?php echo $sites['configs']->sitename; ?></title>
							...
							<table class="table table-hover">
								...
								<tbody>
									<?php foreach($list as $v): ?><tr>
										...
										<th><?php echo $v['hot']; ?></th>
										<th><?php echo $v['rip']; ?></th>
										<th><?php echo $v['sip']; ?></th>
										<th><?php echo $v['tim']; ?></th>
										<th>
											<a href="/Console/Commands/Add/<?php echo $v['ack']; ?>" class="btn btn-default btn-xs">下达命令</a>
											<a href="/Console/Devices/Info/<?php echo $v['ack']; ?>" class="btn btn-info btn-xs">详情</a>
											<a href="/Console/Devices/Delete/<?php echo $v['ack']; ?>" class="btn btn-danger btn-xs" data-no-instant>删除</a>
										</th>
									</tr><?php endforeach; ?>
								</tbody>
							</table>
